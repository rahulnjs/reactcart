...
export const BookDetails: React.FC<Props> = ({ books = [], addToCart, showToast }) => {
        ...
        <div className="book">
          ...
          <div className="book__info">
            ...
            <div className="book__action">
              <button className="btn-secondary" onClick={_addToCart}> <i className="fas fa-cart-plus"></i> Add to Cart</button>
